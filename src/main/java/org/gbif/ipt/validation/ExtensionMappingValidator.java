...
public class ExtensionMappingValidator {
  ...
  public static class ValidationStatus {
    ...
    private final List<ConceptTerm> missingRequiredFields = new ArrayList<ConceptTerm>();
    private final List<ConceptTerm> wrongDataTypeFields = new ArrayList<ConceptTerm>();
