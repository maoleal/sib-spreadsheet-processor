...
import net.sibcolombia.sibsp.service.portal.implementation.SourceManagerImplementation;
 ...
 */
@ImplementedBy(SourceManagerImplementation.class)
public interface SourceManager {
   ...
   *        will be ignored
   */
  int importArchive(Resource resource, File file, boolean overwriteEml) throws ImportException;
   ...
   */
  ClosableIterator<String[]> rowIterator(Source src) throws SourceException;
